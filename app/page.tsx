import { IndexClient } from "@/components/Client";
  ...
  return (
    <div className="flex min-h-[100dvh] items-center justify-center bg-gray-100 px-4 dark:bg-gray-950">
      <div className="mx-auto max-w-md space-y-6 text-center flex items-center flex-col">
        ...
        <p className="text-gray-500 dark:text-gray-400">
          After signin in, check the cookies in the DevTool -&gt; Application
          tab to see the session cookie being applied to this domain.
        </p>
        <Link
